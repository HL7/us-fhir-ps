...
#### Adding Translation Concept Codes from US Terminologies to SNOMED CT 
...
FHIR representation of translation concepts: When an element uses CodeableConcept, the original US terminology code and an international translation may be included as separate Coding entries within the same CodeableConcept. The US coding used to satisfy the applicable US Core binding can be retained, with the mapped SNOMED CT or other IPS-preferred coding added as a translation. Translation codings represent the same underlying clinical concept, follow established mappings when available, and do not alter the applicable binding requirements.  
...
- §terminology-2: Document creators **SHOULD** retain US codes and concepts when adding international concepts.§   
