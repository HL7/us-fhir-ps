...
The United States Patient Care Summary (US-PCS) is a FHIR document that captures key information for care transitions. It aligns with work from the [FHIR International Patient Summary](https://hl7.org/fhir/uv/ips/STU2/) and is intended as a modern, streamlined summary that builds on the long-standing exchange of clinical documents in the United States using the [Consolidated Clinical Document Architecture (C-CDA)](https://hl7.org/cda/us/ccda/) and specifically the [Continuity of Care Document (CCD)](https://hl7.org/cda/us/ccda/StructureDefinition-ContinuityofCareDocumentCCD.html).
