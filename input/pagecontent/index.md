...
The United States Patient Care Summary (US-PCS) is a FHIR document that captures key information for care transitions. It conforms to the [FHIR International Patient Summary (IPS)](https://hl7.org/fhir/uv/ips/STU2/), derives its profiles from [FHIR Clinical Documents (1.1.0)](https://hl7.org/fhir/uv/fhir-clinical-document/STU1.1/en/), and applies additional constraints relevant to the United States. Its use is intended as a modern, streamlined summary that builds on the long-standing exchange of clinical documents in the United States. All US-PCS document instances will conform to the FHIR IPS specification.
